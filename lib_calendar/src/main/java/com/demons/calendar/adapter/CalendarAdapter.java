...
import com.demons.calendar.model.Solar;
...
public class CalendarAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    private CalendarConfig mnCalendarConfig;
    ...
    public CalendarAdapter(Context context, ArrayList<Date> mDatas, ArrayList<CalendarEventModel> mEventDatas, Calendar currentCalendar, Calendar selectedCalendar, CalendarConfig mnCalendarConfig) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View inflate = layoutInflater.inflate(R.layout.item_calendar, parent, false);
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, final int position) {
        if (holder instanceof MyViewHolder) {
            ...
            myViewHolder.iv_item_bg.setBackground(context.getResources().getDrawable(R.drawable.item_bg));
            ...
            if (mEventDatas != null && mEventDatas.size() > 0) {
                for (int i = 0; i < mEventDatas.size(); i++) {
                    CalendarEventModel mnCalendarEventModel = mEventDatas.get(i);
                    Date eventDate = mnCalendarEventModel.getEventDate();
                    String event_yyy_MM_dd = Constants.sdf_yyy_MM_dd.format(eventDate);
            ...
            String now_yyy_MM_dd = Constants.sdf_yyy_MM_dd.format(nowDate);
            ...
            if (selectedCalendar != null) {
                ...
                String selected_yyy_MM_dd = Constants.sdf_yyy_MM_dd.format(selectedDate);
