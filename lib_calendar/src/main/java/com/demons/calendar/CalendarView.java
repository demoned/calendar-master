...
import com.demons.calendar.view.CalendarMonthPagerView;
;
...
public class CalendarView extends LinearLayout implements View.OnClickListener {
    ...
    public CalendarView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        maxYear = ta.getInteger(R.styleable.CalendarView_Calendar_maxYear, 2100);
        minYear = ta.getInteger(R.styleable.CalendarView_Calendar_minYear, 1900);
        ta.recycle();
    ...
    public void setEventDatas(ArrayList<CalendarEventModel> mEventDatas) throws ParseException {
        ...
        for (int i = 0; i < viewPagerCalendar.getChildCount(); i++) {
            CalendarMonthPagerView view = (CalendarMonthPagerView) viewPagerCalendar.getChildAt(i);
            if (view != null) {
    ...
    private void drawTitleViews() {
        ...
        if (!mnCalendarConfig.isMnCalendar_showTitle()) {
            ...
            try {
                ...
                tv_calendar_title.setText(Constants.sdf_yyyy_MM.format(getCurrentDate()));
            }
            //标题颜色值
    ...
    private class MNViewPagerAdapter extends PagerAdapter {
        ...
        public Object instantiateItem(ViewGroup container, int position) {
            ...
            calendar.setTime(date);
            //绘制月份显示
            CalendarMonthPagerView calendarMonthPagerView = new CalendarMonthPagerView(context);
                ...
                public void onSelectedChange(Calendar selectedCalendar) {
                    ...
                    if (date.getMonth() != currentDate.getMonth()) {
                        if (date.getMonth() < currentDate.getMonth() && date.getYear() <= currentDate.getYear()) {
                            CalendarMonthPagerView view = (CalendarMonthPagerView) viewPagerCalendar.findViewWithTag(viewPagerCalendar.getCurrentItem() - 1);
                            if (view != null) {
